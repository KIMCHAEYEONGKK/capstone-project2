...
class CommonManager(BaseUserManager):
    def create_user(self, name, username, weight_l, gender,age, tall, exercise,password=None):
        if not name:
    ...
    def create_superuser(self, age,tall,weight_l,name,exercise,username,gender, password):
...
class Common(AbstractBaseUser):
    ...
    exercise = models.CharField(max_length=100,verbose_name="운동여부")
    weight_l = models.CharField(max_length=3, verbose_name="체중")
    ...
    REQUIRED_FIELDS = ['name','age','tall','gender','exercise','weight_l']
